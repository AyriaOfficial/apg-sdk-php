...
/**
 * AyriaPaymentV1CancelCommand Class Doc Comment
 *
 * @category Class
 ...
 */
class AyriaPaymentV1CancelCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AyriaPaymentV1CancelCommand';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cancel_description'] === null) {
            $invalidProperties[] = "'cancel_description' can't be null";
        }
     ...
     *
     * @param string $cancel_description Cancel description
     *
     * @return self
     */
